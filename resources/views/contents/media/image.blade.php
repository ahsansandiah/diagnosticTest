		                ...
		                <tbody>
		                	...
		                	@foreach ($images as $key => $image)
				                <tr>
				                  	...
				                  	<td><img src="{{ $path.'/'.$image->file_name }}" width="30%"></td>
				                  	<td>
				                  		<a href="{{ $path.'/'.$image->file_name }}" class="btn btn-default btn-xs" target="_blank"><i class="fa fa-download"></i> Download</a>
				                  		<a href="{{ url('admin/media/delete/'.$image->id.'/image' )}}" class="btn btn-default btn-xs"><i class="fa fa-trash"></i> Delete</a>
				                  	</td>
				                </tr>
			                @endforeach
		             	</tbody>
