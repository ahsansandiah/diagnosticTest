    ...
    <div class="col-md-8">
        <div class="box box-primary">
            <div class="box-header with-border">
                <h3 class="box-title">Test - Formative</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
                ...
                <div class="timeline-item">
                    <span class="time pull-right"><i class="fa fa-clock-o"></i> {{ $question->time_limit }}</span>
                    <br>
                        ...
                        <table class="table table-bordered">
                            ...
                            @if(!empty($question->answers))
                                <form method="POST" action="{{ url('/evaluation/diagnostic/'.$confluenceName.'/submit') }}">
                                    ...
                                    <input type="text" name="time_limit" value="" id="time_limit">
