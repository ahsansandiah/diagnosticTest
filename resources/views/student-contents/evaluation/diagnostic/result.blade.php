    ...
    <div class="col-md-6">
        ...
        <div class="box box-widget widget-user-2">
            ...
            <div class="widget-user-header bg-yellow">
                ...
                <!-- /.widget-user-image -->
                <h3 class="widget-user-username">Result</h3>
            </div>
    ...
    <div class="col-md-6">
        ...
        <div class="box box-widget widget-user-2">
            ...
            <div class="widget-user-header bg-yellow">
                ...
                <!-- /.widget-user-image -->
                <h3 class="widget-user-username">Questions and Points</h3>
            </div>
            <div class="box-footer no-padding">
                <ul class="nav nav-stacked">
                    @foreach ($questions as $element)
                        <li>
                            <a href="#">{{ 'Soal No.'.$element->order }} 
                                <span class="pull-right badge bg-blue">
                                    @if (!is_null($element->evaluation))
                                        {{ $element->evaluation->score }}
                                    @else
                                        0
                                    @endif
                                </span>
